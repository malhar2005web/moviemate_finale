...
const HomeScreen = () => {
    ...
    console.log("Backdrop path:", trendingContent?.backdrop_path);
...
{/* 
                        ...
                        >
                            <Video className='size-6 mr-2 fill-black' />
                            Play Trailer
                        </Link> */}
            ...
            <div className='flex flex-col gap-10 bg-black py-10'>
                {contentType === "movie"
                    ? MOVIE_CATEGORIES.map((categories) => (
                          <MovieSlider key={categories} categories={categories} />
                      ))
                    : TV_CATEGORIES.map((categories) => (
                          <MovieSlider key={categories} categories={categories} />
                      ))}
            </div>
        </>
